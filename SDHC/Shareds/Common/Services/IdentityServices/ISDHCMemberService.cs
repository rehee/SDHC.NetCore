...
namespace Common.Services
{
  ...
  public interface ISDHCMemberService<TUser, IdentityResult, Claim, ClaimsPrincipal, UserLoginInfo, IUserValidator, IUserTwoFactorTokenProvider>
  {
    IQueryable<TUser> Users { get; }
    IEnumerable<IUserValidator> UserValidators { get; }
